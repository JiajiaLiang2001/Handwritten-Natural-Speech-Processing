...
class Linear(Module):
    ...
    def backward(self, G):
        ...
        self.W = self.W - lr * (self.u * self.last_grad_W + (1 - self.u) * delta_W)
        self.last_grad_W = delta_W

        self.b = self.b - lr * (self.u * self.last_grad_b + (1 - self.u) * delta_b)
        self.last_grad_b = delta_b
        return G @ self.W.T
