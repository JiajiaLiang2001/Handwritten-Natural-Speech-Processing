...
class Linear(Module):
    ...
    def backward(self, G):
        ...
        self.W.weight = self.W.weight - lr * (self.u * self.last_grad_W + (1 - self.u) * self.W.grad)
        self.last_grad_W = self.W.grad

        self.b.weight = self.b.weight - lr * (self.u * self.last_grad_b + (1 - self.u) * self.b.grad)
        self.last_grad_b = self.b.grad
